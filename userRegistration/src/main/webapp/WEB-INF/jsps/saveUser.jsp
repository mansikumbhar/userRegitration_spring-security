...
<body>
<body>
	<form action="saveRegistrationInfo" method="post">
  <div class="container">
    <h1>Register</h1>
    ...
    <input type="text" placeholder="Enter emp_id" name="emp_id" id="emp_id" required>

	<label for="emp-name"><b>Name</b></label>
    <input type="text" placeholder="Enter name" name="emp_name" id="emp_name" required>
